...
const NotificationDetails = ({ route }) => {
  ...
  console.log('Notification Item Data:', notificationItemData);
        ...
        <MainContainer>
          ...
          <NotificationDetailsContainer>
            <NotificationDetailsTop>
              ...
              <NotificationDetailsTitle>{notificationItemData.notificationTitle}</NotificationDetailsTitle>
              <NotificationDateandTimeContainer>
            ...
            <NotificationDetailsBottom>
              <NotificationDetailsDescription>{notificationItemData.notificationBody}</NotificationDetailsDescription>
            </NotificationDetailsBottom>
          </NotificationDetailsContainer>
          </ScrollView>
