...
import { View, Text, StyleSheet, Image, SectionList, ScrollView, ActivityIndicator, FlatList } from "react-native";
...
export default ({ history, loading = false }) => {
  ...
  return  <View style={{ flex: 1, height: '100%', paddingBottom: 10 }}>
  {loading ? (
    <ActivityIndicator />
  ) : (
    <FlatList
  ...
  // <ScrollView style={{ flex: 1, height: '100%', paddingBottom: 10 }} contentContainerStyle={{ alignItems: 'center', justifyContent: 'center' }}>
