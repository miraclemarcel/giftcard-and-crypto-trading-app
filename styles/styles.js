...
export const InputModal = styled.View`
    ...
    height: 70%;
`;
export const BankInputModal = styled.View`
    backgroundColor: ${({ theme }) => theme.backgroundColor};
    padding: 20px;
    borderTopLeftRadius: 30px;
    borderTopRightRadius: 30px;
...
export const WalletContainer = styled.View`
    width: 100%;
    background:  ${({ theme }) => theme.homeWalletColo};
    height: 130px;
    margin-top: 16px;
    display: flex; 
    flex-direction: row; 
...
export const StarText = styled.Text`
    color:  ${({ theme }) => theme.walletPriceText};
    fontSize: 18px;
`;
...
export const WithdrawButton = styled.TouchableOpacity` 
    background:  ${({ theme }) => theme.walletWithdrawBtn};
    display: flex;
    padding: 8px;
    flex-direction: row;
    gap: 16px;
...
export const CurrencyBtn = styled.View`
    width: 100%;
    height: 40px;
    background:  ${({ theme }) => theme.walletNGNBtn};
    display: flex;
    flexDirection: row;
    alignItems: center;
    justifyContent: space-between;
...
export const TradeButtonDetails = styled.Text`
    fontSize: 11px;
    color:  ${({ theme }) => theme.inputPlaceHolderTextAlt};
`;
...
export const Buy = styled.View`
    background:  ${({ theme }) => theme.BuyOrSellBtn};
    padding: 10px;
    height: 160px;
    width: 48%;
    borderRadius: 15px;
...
export const SettingsContainer = styled.TouchableOpacity`
    width: 100%;
    height: 70px;
    background: ${({ theme }) => theme.SeetingsSections}; 
    marginTop: 10px;
    borderRadius: 8px;
    display: flex;
    flexDirection: row;
...
export const GiftcardTitle = styled.Text`
    fontSize: 16px;
    fontWeight: bold;
    color:  ${({ theme }) => theme.white};
`;
export const  GiftcardSubTitle = styled.Text`
    color:  ${({ theme }) => theme.white};
`;
export const  GiftcardPrice = styled.Text`
    color:  ${({ theme }) => theme.white};
    fontSize: 14px;
`;
...
export const NoBankAlert = styled.View`
    ...
    backgroundColor:  ${({ theme }) => theme.backgroundColor};
    `;
export const AddBankAlert = styled.View`
    display: flex;
    marginTop: 30px;
    alignItems: center;
    justifyContent: center;
...
export const NoBankAlertText = styled.Text`
    ...
    paddingTop: 20px;
`;
export const AddBankAlertText = styled.Text`
    fontSize: 13px;
    color:  ${({ theme }) => theme.white};
    paddingTop: 20px;
`;
